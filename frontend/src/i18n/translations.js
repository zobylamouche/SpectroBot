...
export const translations = {
  en: {
    ...
    settings: {
      ...
      feature5: "Configurable AI market analysis",
  ...
  fr: {
    ...
    settings: {
      ...
      feature5: "Analyse de marché IA configurable",
  ...
  es: {
    ...
    settings: {
      ...
      feature5: "Análisis de mercado IA configurable",
  ...
  de: {
    ...
    settings: {
      ...
      feature5: "Konfigurierbare KI-Marktanalyse",
